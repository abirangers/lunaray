...
<head>
    ...
    <link
        href="https://fonts.bunny.net/css?family=inter:400,500,600,700|playfair-display:400,500,600,700|jetbrains-mono:400,500,600"
        rel="stylesheet" />
...
<body class="h-full bg-white">
    <div class="min-h-full">
                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        @auth
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open"
                                    class="flex items-center space-x-2 text-sm text-neutral-700 hover:text-neutral-900 focus:outline-none">
                        ...
                        @else
                            ...
                            <div class="flex items-center space-x-4">
                                <a href="{{ route('login') }}"
                                    class="bg-neutral-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-neutral-800 transition-colors">
                                    Get Started
                                </a>
                            </div>
                        @endauth
     ...
     ============================================ --}}
        ...
        <div class="bg-[#1a1a1a] text-center py-4">
            <p class="text-sm text-gray-400">
                © {{ date('Y') }} Lunaray Beauty. All rights reserved.
            </p>
        </div>
    </div>
