                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div id="preview-description" class="text-sm text-gray-600">{{ old('description', $category->description) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6 mt-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="text-center">
                    <div class="text-2xl font-bold text-primary">{{ $category->articles->count() }}</div>
                    <div class="text-sm text-gray-600">Total Articles</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-green-600">{{ $category->articles()->published()->count() }}</div>
                    <div class="text-sm text-gray-600">Published</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-yellow-600">{{ $category->articles()->draft()->count() }}</div>
                    <div class="text-sm text-gray-600">Drafts</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-gray-900">{{ $category->created_at->format('M j') }}</div>
