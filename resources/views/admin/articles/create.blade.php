...
@section('pageTitle', 'Create New Article')
@section('pageDescription', 'Write and publish a new article for your audience with our advanced editor')
...
@section('content')
    ...
    <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" x-data="{ 
        showPreview: false,
        autoSave: false,
        lastSaved: null,
        saveStatus: 'idle'
        ...
        <div class="card-modern">
            <div class="card-modern-header">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">Provide the essential details for your article</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3" 
                                  ...
                                  placeholder="Brief description of the article (optional but recommended for SEO)">{{ old('excerpt') }}</textarea>
        ...
        <div class="card-modern">
            <div class="card-modern-header">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">Add a compelling visual that represents your article</p>
            </div>
            <div class="card-modern-body">
                <div class="space-y-4">
                    <div>
                        <label for="featured_image" class="form-modern-label">Upload Featured Image</label>
                        <div class="mt-1 flex justify-center px-6 pt-8 pb-8 border-2 border-dashed border-neutral-300 dark:border-neutral-600 rounded-xl hover:border-primary-400 dark:hover:border-primary-500 transition-colors duration-200 bg-neutral-50 dark:bg-neutral-800/50">
                            <div class="space-y-3 text-center">
                                ...
                                <div class="flex text-sm text-neutral-600 dark:text-neutral-400">
                                    <label for="featured_image" class="relative cursor-pointer bg-white dark:bg-neutral-800 rounded-lg font-medium text-primary-600 hover:text-primary-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500 px-3 py-1">
                                        <span>Upload a file</span>
                                        <input type="file" name="featured_image" id="featured_image" accept="image/*" 
                                               class="sr-only @error('featured_image') form-modern-error @enderror">
                                    </label>
            ...
            <div class="card-modern-header">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-neutral-600 dark:text-neutral-400">Write your article using our rich text editor</p>
                    </div>
        ...
        <div class="card-modern">
            <div class="card-modern-header">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">Configure categories, status, and visibility options</p>
            </div>
            <div class="card-modern-body">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <select name="status" id="status" 
                                ...
                                <option value="draft" {{ old('status') == 'draft' ? 'selected' : '' }}>Draft - Save for later editing</option>
                                <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Published - Make visible to readers</option>
                            </select>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-6 border-t border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center space-x-4">
                <div class="flex items-center space-x-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <span x-text="lastSaved ? 'Last saved: ' + lastSaved : 'Not saved yet'"></span>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                ...
                <button type="button" class="btn-modern btn-modern-secondary" @click="autoSave = !autoSave" :class="autoSave ? 'bg-success-100 text-success-700 border-success-300' : ''">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path>
                    </svg>
                    <span x-text="autoSave ? 'Auto-save ON' : 'Auto-save OFF'"></span>
                </button>
