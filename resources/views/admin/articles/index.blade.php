        ...
        <div class="card-modern-header">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0 flex items-center gap-3">
                    ...
                    <a href="{{ route('articles.export', request()->query()) }}" class="btn-modern btn-modern-secondary">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="table-modern-row">
                            ...
                            <td class="table-modern-cell">
                                <div class="flex items-center space-x-1">
                                    <a href="{{ route('articles.show', $article) }}" class="btn-modern btn-modern-ghost p-2" title="View">
