<x-layouts.admin pageTitle="Admin Dashboard" pageDescription="Welcome to the Lunaray Beauty Factory admin panel">
    <!-- Welcome Section -->
    <div class="bg-white overflow-hidden shadow-xl rounded-lg mb-8">
        <div class="px-4 py-5 sm:p-6">
            ...
            <p class="text-lg text-gray-600 mb-6">
                ...
                <span class="font-semibold text-primary">{{ Auth::user()->getRoleNames()->first() }}</span> 
                privileges.
            </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 space-y-2">
                    <a href="{{ route('admin.articles') }}" class="block text-blue-600 hover:text-blue-500 font-medium">Manage Articles →</a>
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 space-y-2">
                    <a href="{{ route('admin.users') }}" class="block text-red-600 hover:text-red-500 font-medium">Manage Users →</a>
                    <a href="{{ route('staff.register') }}" class="block text-red-600 hover:text-red-500 font-medium">Create Staff →</a>
                </div>
            </div>
        </div>
        @endif
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 space-y-2">
                    <a href="{{ route('admin.settings') }}" class="block text-yellow-600 hover:text-yellow-500 font-medium">System Settings →</a>
